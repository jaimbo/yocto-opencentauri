...
with open("/user-resource/stage1.bin", "wb") as f:
    f.write(data)

subprocess.run(["openssl", "enc", "-d", "-aes-256-cbc", "-d", "-in", "/user-resource/stage1.bin", "-out", outfilepath, "-K", key, "-iv", iv, "-nopad"])

os.unlink("/user-resource/stage1.bin")
